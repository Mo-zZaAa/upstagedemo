# ThinkFlow: Cognitive AI Partner for Unstructured Thought Processing

ThinkFlow는 산만한 생각과 원본 문서를 계층적 Logic Tree와 Action Plan으로 바꿔 주는 Cognitive AI Agent입니다. Upstage Solar Pro의 추론 능력과 Solo Consultant 페르소나를 사용해 학생 및 1인 작업자를 지원합니다.
